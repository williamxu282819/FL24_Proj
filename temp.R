...
## crowds_copy
# # A tibble: 6 × 3
# category  avg_confidence_cnn avg_accuracy
# <fct>                  <dbl>        <dbl>
#   1 (0.4,0.5]              0.458        0.293
# 2 (0.5,0.6]              0.554        0.400
# 3 (0.6,0.7]              0.650        0.612
# 4 (0.7,0.8]              0.750        0.802
# 5 (0.8,0.9]              0.844        0.912
# 6 (0.9,1]                0.943        0.980
